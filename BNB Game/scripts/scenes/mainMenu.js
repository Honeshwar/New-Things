...
export default function mainMenu() {
    ...
    const bgPieces = [
        ...
        k.add([
            k.sprite("chemical-bg"),
            k.pos(bgPieceWidth, 0),//*2 because we scale the bg by 2 above, sue to it become 2x and on scroll that partsare more than bgPieceWidth*2 , so now distance covered is 2*bgPieceWidth
            k.scale(1),
            k.opacity(1),
    ...
    const platformWidth = 1440//1280;
    const platforms = [
        k.add([
            k.sprite("platforms"),
            k.pos(0, 0),//height - 300
            k.scale(4),
            k.opacity(0)
        ...
        k.add([
            k.sprite("platforms"),
            k.pos(platformWidth * 4, 0),//height - 300
            k.scale(4),
            k.opacity(0)
        ])
    ]
    ...
    makeSonic(k.vec2(200, 400 / 2 + 50))//x,y
    ...
    k.onUpdate(() => {
        ...
        if (bgPieces[1].pos.x < 0) {
            ...
            bgPieces[0].moveTo(bgPieces[1].pos.x + bgPieceWidth * 1, 0);
        ...
        bgPieces[1].moveTo(bgPieces[0].pos.x + bgPieceWidth * 1, 0);
